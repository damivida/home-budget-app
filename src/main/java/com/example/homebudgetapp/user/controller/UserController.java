...
public class UserController {
    ...
    public ResponseEntity<UserIncomeResponse> addUserIncome(@Valid @RequestBody UserIncomeDto userIncomeDto)  {
    ...
    public ResponseEntity<UserResponse> updateUser( @Valid @RequestBody UserPatchDto userDto)  {
